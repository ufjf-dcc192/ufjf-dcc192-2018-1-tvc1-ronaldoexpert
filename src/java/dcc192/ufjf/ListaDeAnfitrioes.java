...
public class ListaDeAnfitrioes {
    ...
    public static List<Anfitriao> getInstance(){
        if(anfitrioes == null){
            ...
            anfitrioes.add(new Anfitriao("Ronaldo S.", "Apartamento", "1 quarto mobiliado", "N", "(32) 9999-9999"));
            ...
            anfitrioes.add(new Anfitriao("Raquel F.", "Casa", "Área comum com 2 conchões de solteiro", "S", "(32) 9999-9999"));
            anfitrioes.add(new Anfitriao("Vania B.", "Casa", "1 quarto mobiliado", "S", "(32) 9999-9999"));
        }
        return anfitrioes;
    }
}
